...
const cacheName = '_75ProjectTeama6-2021-11-03 14:30:09.408010'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, '_75ProjectTeama6'.length) === '_75ProjectTeama6') {
